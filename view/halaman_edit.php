                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto me-4">
                            <li class="nav-item mx-2">
                                <a class="nav-link active" href="#"><i class="fa-solid fa-envelope"
                                        data-bs-toggle="tooltip" title="Surat Masuk"></i></a>
                            </li>
                            <li class="nav-item mx-2">
                                <a class="nav-link active" href="#"><i class="fa-solid fa-bell" data-bs-toggle="tooltip"
                                        title="Notifikasi"></i></a>
                            </li>
                            <li class="nav-item mx-2">
                                <a class="nav-link active" href="dashboard.php"><i
                                        class="fa-solid fa-arrow-right-from-bracket" data-bs-toggle="tooltip"
                                        title="Logout"></i></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row" id="card">
            <div id="card-content">
                ...
                <form method="post" class="form" action="halaman_edit.php">
                    ...
                    <input id="user-email" class="form-content" type="text" name="username" value="<?=$data['nama']?>"
                        required />
                    ...
                    <input id="matkul" class="form-content" type="text" name="matkul" value="<?=$data['Matakuliah']?>"
